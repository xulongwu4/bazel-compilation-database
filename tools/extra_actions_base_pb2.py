...
# source: tools/extra_actions_base.proto
...
_JAVACOMPILEINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='argument', full_name='blaze.JavaCompileInfo.argument', index=8,
...
ExtraActionSummary = _reflection.GeneratedProtocolMessageType('ExtraActionSummary', (_message.Message,), dict(
  ...
  __module__ = 'tools.extra_actions_base_pb2'
